...
# ------------------------------------------------------------------------------------------------------ #
DIR_MAIN = "/home/avinash/Supernovae_Data/2016gfy/"
# ------------------------------------------------------------------------------------------------------ #
...
# ------------------------------------------------------------------------------------------------------ #
list_dates = [folder_name for folder_name in os.walk(DIR_MAIN).next()[1] if '-' in folder_name]
list_filters = ['u', 'b', 'v', 'r', 'i']
list_patterns = ['ca_' + date + '_fbs_2016gfy-' + band for date in list_dates for band in list_filters]

list_list_comb = []
for pattern in list_patterns:
    if len(group_similar_files("", pattern + "*")) != 0:
	group_similar_files('list_' + pattern, pattern + "*")
