...
# ------------------------------------------------------------------------------------------------------------------- #
# Remove Residual Files From Previous Run Of Spectroscopy Tasks
# ------------------------------------------------------------------------------------------------------------------- #
if remove_resfile:
...
# ------------------------------------------------------------------------------------------------------------------- #
group_similar_files('list_object', common_text=OBJECT_NAME + '*.fits')
...
hedit('list_Feige66', 'OBJECT', 'Feige66')
hedit('list_Halogen', 'OBJECT', 'Halogen')
hedit('list_object', 'OBJECT', OBJECT_NAME)
# ------------------------------------------------------------------------------------------------------------------- #
