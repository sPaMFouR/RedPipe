...
def translation(template_array, sub_array, scale_exponent=0.4):
    ...
    template_array = list_array[0]
    sub_array = list_array[1]

    dict_shift = ird.translation(template_array, sub_array)
...
def similarity(template_array, sub_array, scale_exponent=0.4):
    ...
    dict_rot = ird.similarity(template_array, sub_array, numiter=3, order=2, constraints=dict_constraint)
