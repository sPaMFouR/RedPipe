...
def psf_phot(textlist_files, textlist_fwhm, mag_suffix='.mag.2', psf_radius='1', data_max='INDEF'):
    """
...
# ------------------------------------------------------------------------------------------------------------------- #
if remove_resfile:
    for text in ['tmp*', '*.pst.*', '*.psf.*', '*.psg.*', '*.als.*', '*.arj.*', '*.sub.*', 'ca_*.mag.*', 'log*']:
