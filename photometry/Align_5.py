...
def imexam_coords(file_name, ref_coords, log_file):
    """
    Examines the image 'file_name' at the coordinates mentioned in the file 'stars.coo' and logs the
    output onto the file 'log_imexam' using the IMEXAMINE task.
    Args:
        file_name   : Subject image which needs to be aligned
