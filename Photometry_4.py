...
def psf_phot(text_list_files, text_list_fwhm, mag_suffix='.mag.2', psf_radius='1', data_max='INDEF'):
    """
    ...
    for index in range(0, len(list_files)):
        ...
        file_psf = str(list_files[index]) + ".psf." + str(run_count) + ".fits"
...
#                          default='stars.coo')
# coord_file2 = eg.enterbox(msg='Enter The File With Coordinates Of Field Stars:', title='Field Star Coordinates',
#                           default='stars_sn.coo')
# aperture_values = eg.enterbox(msg='Enter The 1st Set Of Apertures At Which Photometry Is To Be Performed:',
#                               title='Apertures For Performing Photometry', default='1')
# aperture_values2 = eg.enterbox(msg='Enter The 2nd Set Of Apertures At Which Photometry Is To Be Performed:',
#                                title='Apertures For Performing Photometry', default='1')
...
# ------------------------------------------------------------------------------------------------------------------- #
run_count = 1
aper_phot(str(text_list), str(text_list_fwhm), str(coord_file2), phot_radius=str(aperture_values2), data_max='INDEF')
aper_phot(str(text_list), str(text_list_fwhm), str(coord_file2), phot_radius=str(aperture_values), data_max='INDEF')
aper_phot(str(text_list), str(text_list_fwhm), str(coord_file), phot_radius=str(aperture_values), data_max='INDEF')
aper_phot(str(text_list), str(text_list_fwhm), str(coord_file), phot_radius=str(aperture_values2), data_max='INDEF')
...
# ------------------------------------------------------------------------------------------------------------------- #
# Groups Mag Files From PHOT Task Into A Separate List
# ------------------------------------------------------------------------------------------------------------------- #
mag_suffix = 4
...
# ------------------------------------------------------------------------------------------------------------------- #
list_dates = []
list_dates = [file_name[3:13] for file_name in list_mag if not file_name[3:13] in list_dates]
# ------------------------------------------------------------------------------------------------------------------- #


# ------------------------------------------------------------------------------------------------------------------- #
# Groups MAG Files From A Date Into A File "list_date_mag4", Applies TXDUMP Task To Obtain "output_date_mag4"
# Also Computes Tabular Magnitude Files From IRAF MAG Files Generated Through Photometry
# ------------------------------------------------------------------------------------------------------------------- #
for date in list_dates:
    file_mag = "output_" + str(date) + "_mag" + str(mag_suffix)
    txdump(common_text="*" + str(date) + "*.mag." + str(mag_suffix), output_file=str(file_mag))
    tabular_mag(input_file=str(file_mag), output_file="OUTPUT_tabular_" + str(date))
...
als_suffix = 1
for date in list_dates:
    file_als = "output_" + str(date) + "_als" + str(als_suffix)
    txdump(common_text="*" + str(date) + "*.als." + str(als_suffix), output_file=str(file_als))
    tabular_mag(input_file=str(file_als), output_file="OUTPUT_tabularpsf_" + str(date))
